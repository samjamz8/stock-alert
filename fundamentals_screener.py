...
def screen_stock(symbol: str) -> dict | None:
    ...
    try:
        ...
        rev_growth, profit_growth, latest_revenue, latest_profit = _yoy_growth_from_financials(t)
        ...
        return {
            ...
            "revenue_cr": round(latest_revenue / 1e7, 1) if latest_revenue is not None else None,
            "profit_cr": round(latest_profit / 1e7, 1) if latest_profit is not None else None,
